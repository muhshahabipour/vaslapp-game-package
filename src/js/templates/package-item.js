                                    ...
                                    <div class="col-xs-12 col-md-6 col-lg-4">
                                        <div class="form form-group">
                                            ...
                                            <div class="form-select">
                                                <select class="form-entry" name="packageModels[${i}].pointId" id="point-${obj.id}" data-id="${obj.id}" data-name="pointId">
                                                    <option value="">یک متغیر را انتخاب کنید</option>
                                                    ${typeof option !== "undefined" ? option.map(item => `<option value="${item.id}" ${obj.pointId == item.id ? `selected="selected"`: ``}>${item.title}</option>`).join('') : ``}
                                                </select>
                                            </div>
                                        </div>
                                    </div>
